...
//		System.out.println(result);
	...
	public void practice2() {
		...
		// 입력한 문자가 대문자이면
		// "알파벳 대문자이다." : "알파벳 대문자가 아니다."
		String check = ('A' <= a && a <= 'Z') ? "알파벳 대문자이다." : "알파벳 대문자가 아니다";
...
//		if(op == '+' || op == '-') {
//			System.out.printf("%d %s %d = %d", num1, op, num2,
...
//		}
		...
		result = op == '+' 
				...
				: op == '-'
				  ...
				  : "잘못 입력했습니다";
		System.out.println(result);
//		System.out.printf("%d %s %d = %d", num1, op, num2, op == '+' ? (num1+num2) :(num1-num2));
	}

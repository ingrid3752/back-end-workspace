...
public class B_Time {
	...
	public void method2() {
		...
		System.out.println("pe : " + pe); // P1Y(년의 차이)11M (월의 차이)30D(일의 차이)
		...
		System.out.println(du); // PT 11H 59M 59S

		System.out.println("hours : " + du.toHours()); // 11
		System.out.println("minutes : " + du.toMinutes()); // 719
		System.out.println("seconds : " + du.toSeconds()); // 43199
	 ...
	 */
	public void method3() {
		// System.out.println("D-" + ChronoUnit.DAYS.between(date1, date2));

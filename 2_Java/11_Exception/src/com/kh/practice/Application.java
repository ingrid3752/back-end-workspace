...
public class Application {
	...
	/*
	 * 회원 수가 3명이 최대 등록 가능 3명 모두 등록되면 "회원 수가 모두 꽉 찼기 때문에 일부 메뉴만 오픈됩니다."와 함께 1. 새 회원
	 * 등록 하지 못하게 화면상 보이지 않게 처리!
	 * 
	 * 최대 등록 가능한 회원 수는 3명입니다. 현재 등록된 회원 수는 ~~명입니다. 1. 새 회원 등록 -> insertMember() 2.
	 * 회원 정보 수정 -> updateMember() 3. 전체 회원 정보 출력 -> printAll() 9. 끝내기 -> 프로그램 종료 그
	 * 외의 번호 -> 잘못 입력하셨습니다. 다시 입력해주세요
	 * 
	 * 메뉴 번호 :
	 */

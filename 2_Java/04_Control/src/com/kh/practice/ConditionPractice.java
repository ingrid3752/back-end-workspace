...
//    }
    ...
    public void method3() {
        ...
        // 최소 한 조각 이상 피자를 먹으려면 최소 몇 판의 피자를 시켜야 하는지
...
//    	System.out.println(price);
    ...
    public void method6() {
    	...
    	// 예각일 때 1직각일 때 2, 둔각일 때 3, 평각일 때 4
    	if(0 < angle && angle < 90) {
    		result = 1;
    	} else if(angle == 90) {
    		result = 2;
    ...
    */
    ...
    public void method10() {
    	...
    	// switch(n) {case n: 입력값 = ~~ break; (return;)}
    	switch(num) {
    		case 1:
    			result = "입력 메뉴입니다";
    			break;
    	...
    	System.out.println(result); // || 프로그램이 종료됩니다.
    }

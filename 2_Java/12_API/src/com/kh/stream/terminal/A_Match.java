...
public class A_Match {
	...
	public void method1() {
		...
		System.out.println("짝수만 가지고 있는가? " + result); // true (and 연산자)
		
		result = Arrays.stream(values).anyMatch(value -> value % 3 == 0);
		System.out.println("3의 배수 값이 하나라도 있는가? " + result); // true (or 연산자)
	...
	public void method2() {
		...
		System.out.println("나이가 20살 이상인 학생들이 모두 남자인가? " + result); // false
